...
Thank you for considering contributing to Logger.

Please know that everyone is welcome to contribute to Logger.
...
Logger is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to Logger,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/Logger/issues/new/choose) 
...
All changes to Logger source must go through the PR review process before
...
Logger is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/Logger.git
    ```
...
4. Build Logger from the command line by running:
